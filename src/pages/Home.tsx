...
const Home: React.FC = () => {
  const [archicles] = useState<Sample[]>([
    { id: 1, title: "Point1", summary: "This is point1", icon: dummyUser },
    { id: 2, title: "Point2", summary: "This is point2", icon: dummyUser },
    { id: 3, title: "Point3", summary: "This is point3", icon: dummyUser },
  ]);
